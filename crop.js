...
angular.module('app').controller("ImageCropperCtrl",[ '$scope','$http', function($scope, $http) 
{
        $scope.cropper = {};
        ...
        $scope.saveFile = function () {
            var _data = {
                'message': $scope.cropper.croppedImage
            };

            // SEND THE FILES.
            $http.post('/api/fileupload', _data).then(function(respond){
                // if success
                console.log("CROP JS :success: ",respond.data.message);
